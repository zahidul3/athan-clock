/*******************************************************************************
  Filename:       icall_startup.c
  Revised:        $Date: 2014-12-01 08:54:09 -0800 (Mon, 01 Dec 2014) $
  Revision:       $Revision: 41278 $
...
// Check if compiler is IAR or TI compiler
 ...
 * @fn          startup_entry
 *
 * @brief       This is the TIMAC stack entry point.
 *
 * input parameters
 *
...
#error "Error: Must specify a compiler!"
  ...
  // initialzie the BLE Controller ROM
  ROM_Init();
#endif // FLASH_ROM_BUILD
